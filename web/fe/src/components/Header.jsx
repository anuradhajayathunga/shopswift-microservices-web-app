  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1 sm:gap-1">
        ...
        {/* ✅ Dark/Light Toggle */}
        <div
          className="hover:text-primary px-4 group focus:ring-0 rounded-full flex justify-center items-center cursor-pointer text-muted-foreground relative"
          onClick={toggleMode}
        >
          <span className="flex items-center justify-center relative after:absolute after:w-10 after:h-10 after:rounded-md after:-top-1/2   group-hover:after:bg-lightprimary transition-colors">
            {theme === "light" ? (
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="relative px-4  h-9 w-9 text-muted-foreground hover:text-foreground hover:bg-accent rounded-md transition-colors"
            >
              <Bell size={20} />
              {notificationCount > 0 && (
          ...
          >
            <DropdownMenuLabel className="flex items-center justify-between py-2">
              ...
              {notificationCount > 0 && (
                <Badge
                  variant="secondary"
                  className="text-[10px] px-1.5 py-0 h-5 font-medium bg-muted text-muted-foreground"
                >
