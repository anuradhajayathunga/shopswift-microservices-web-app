...
import { Loader2, LayoutDashboard, Eye, EyeOff, User, Mail } from "lucide-react";
    ...
    <div className="min-h-screen w-full bg-background flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      <div className="w-full max-w-[1200px] bg-card rounded-[2rem] shadow-2xl border border-border overflow-hidden flex flex-col lg:flex-row min-h-[760px] animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="w-full lg:w-[45%] p-8 lg:p-12 xl:p-16 flex flex-col relative overflow-y-auto">
          ...
          {/* Brand Logo */}
          <Link to="/" className="flex items-center gap-2 text-xl font-bold tracking-tight text-foreground mb-10 w-fit">
          ...
          {/* Alerts */}
          {error && <div className="mb-4 p-3 text-sm text-red-600 bg-red-50 rounded-md border border-red-100">{error}</div>}
          ...
          <div className="w-full h-full bg-primary rounded-[1.5rem] p-12 flex flex-col relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-md">
              ...
              <p className="text-primary-foreground/80 text-sm">
                Get started today to access secure checkout, customized order management, and powerful platform analytics.
              </p>
            </div>
